...
const checks = [
  ...
  ['TikFinity Chat-Bridge als native Standardansicht', /Batto TikTok-Chat|tiktokChatView.*native/],
  ['TikFinity Originalansicht umschaltbar', /tikfinityChatFrame|TikFinity Originalansicht/],
  ['TikFinity Chat-Link aktiviert die Bridge', /autoConnect:true.*webWidgets|webWidgets.*autoConnect:true/s],
